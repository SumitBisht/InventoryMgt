...
<html>
    <head>
        ...
        <title><%=session.getAttribute("title") != null ? session.getAttribute("title") : "Create New User"%> </title>
    ...
    <body>
        <!-- login.jsp -->
        <div id="login">
            <h1 id="login_title">            <spring:message code="label.register.heading"></spring:message>
</h1>
            <s:form action="registerAction.htm" commandName="user" id="login_form" method="post">
               
               
                <div class="field_container">
                    <s:input type="text" placeholder="User Name"  path="name" class="login-inp" />
                </div>
                
                <div class="field_container">
                    <s:input type="Password" placeholder="Password" path="password" class="login-inp" />
                    
                </div>
            
            
              <div class="field_container">
                    <input type="Password" placeholder="Retype Password" name="rpassword" class="login-inp" />
                    
                </div>
            
             <div class="field_container">
                    <input type="email" placeholder="Email" name="email" class="login-inp" />
                    
                </div>
                
            <button id="sign_in_button">
                        <span class="button_text"><input type="submit" class="btn" value="Register"> </span>
                    </button>
