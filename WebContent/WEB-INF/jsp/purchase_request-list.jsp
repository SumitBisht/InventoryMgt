                                    ...
                                    <tbody>
                                        <c:forEach var="purrequisition" items="${purrequisitionList}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-purchase_request.html?id=${purrequisition.id}" class="btn btn-default btn-sm" type="button"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                                    <a href="delete-purchase_request.html?id=${purrequisition.id}" class="btn btn-default btn-sm row-delete" type="button"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                                </td>
                                            </tr>                                        
                                        </c:forEach>                                        
                                    </tbody>
