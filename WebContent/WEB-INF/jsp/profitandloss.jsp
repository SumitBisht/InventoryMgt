...
<body role="document">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="catagory-main-box top-radius">
					<div class="cat-box-title cat-title-font top-radius">Outgoing</div>
			...
			<div class="col-md-9">
				<div class="catagory-main-box top-radius">
					<div class="cat-box-title cat-title-font top-radius">Profit
						and loss</div>
					<spring:message text="Default Text"
						code="purrequisition.search.placeholder" var="search" />
					<div class="tab-content">
							...
							<table id="dttable" class="table table-bordered table-striped"
								...
								<tbody>
									...
									<tr>
										...
										<c:choose>
											<c:when test="${totali-totalo <0}">
												<td colspan="">Total loss</td>
