...
/*  42:    */ 
/*  43:    */ @Controller
/*  44:    */ public class PurrequisitionController
/*  45:    */ {
/*  46: 53 */   private static final Logger LOG = LoggerFactory.getLogger(PurrequisitionController.class);
/*  47:    */   @Autowired
...
/*  73: 85 */         return PurrequisitionController.this.itemDAO.getRecordByPrimaryKey(Integer.valueOf(itemId));
/*  74:    */       }
/*  75:    */     });
/*  76:    */   }
/*  77:    */   
/*  78:    */   @RequestMapping(value={"/add-purchase_requisition.html"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
/*  79:       @PreAuthorize("hasAnyRole('ROLE_USER') AND hasPermission('purchaserequisition','add')")
*//*  80:    */  
@PreAuthorize("hasAnyRole('ROLE_USER')")
public ModelAndView add_purrequisition_get(@RequestParam(value="success", required=false) String success, @RequestParam(value="error", required=false) String error, HttpServletRequest request, Locale locale)
/*  81:    */     throws Exception
/*  82:    */   {
/*  83: 95 */     LOG.debug("add-purchase_requisition called.");
/*  84: 96 */     ModelAndView mav = new ModelAndView("purchase_requisition");
...
/*  97:    */   }
/*  98:    */   
/*  99:    */   @RequestMapping(value={"/add-purchase_requisition.html"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
/* 100:    */  
@PreAuthorize("hasAnyRole('ROLE_USER')")
...
/* 145:155 */         return new ModelAndView("redirect:edit-purchase_requisition.html?id=" + insertResult).addObject("success", Utilities.getSpringMessage(this.messageSource, "purrequisition.add.success", locale));
/* 146:    */       }
...
/* 151:162 */       return new ModelAndView("purchase_requisition", model).addObject("error", Utilities.getSpringMessage(this.messageSource, "purrequisition.add.error", locale));
/* 152:    */     }
/* 153:167 */     LOG.debug("Purchase_requisition values are not valid:", purrequisition.toString());
...
/* 157:171 */     return new ModelAndView("purchase_requisition", model);
/* 158:    */   }
/* 159:    */   
/* 160:    */   @RequestMapping(value={"/edit-purchase_requisition.html"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
/* 161:    */  
...
/* 170:    */     {
/* 171:185 */        mav = new ModelAndView("purchase_requisition");
...
/* 180:    */     else
/* 181:    */     {
/* 182:195 */       mav = new ModelAndView("redirect:purchase_requisition.html");
/* 183:    */     }
...
/* 191:    */   }
/* 192:    */   
/* 193:    */   @RequestMapping(value={"/edit-purchase_requisition.html"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
/* 194:    */ 
@PreAuthorize("hasAnyRole('ROLE_USER')")
/*@PreAuthorize("hasAnyRole('ROLE_USER') AND hasPermission('purchaserequisition','update')")
...
/* 204:    */       {
/* 205:217 */         LOG.debug("purchase_requisition updated Successfully with id={0}", Integer.valueOf(updateResult));
/* 206:218 */         return new ModelAndView("redirect:edit-purchase_requisition.html").addObject("success", Utilities.getSpringMessage(this.messageSource, "purrequisition.update.success", locale));
/* 207:    */       }
/* 208:222 */       LOG.debug("Error occurred updating purchase_requisition:{0}", purrequisition.toString());
...
/* 212:226 */       return new ModelAndView("purchase_requisition", model).addObject("error", Utilities.getSpringMessage(this.messageSource, "purrequisition.update.error", locale));
/* 213:    */     }
/* 214:231 */     LOG.debug("Purchase_requisition values are not valid:", purrequisition.toString());
...
/* 225:    */   {
/* 226:244 */     LOG.debug("purchase_requisition called.");
/* 227:245 */     ModelAndView mav = new ModelAndView("purchase_requisition-list");
...
/* 253:    */   }
/* 254:    */   
/* 255:    */   @RequestMapping({"/delete-purchase_requisition.html"})
/* 256:    */   @ResponseBody
...
/* 260:    */   {
/* 261:281 */     LOG.debug("delete-purchase_requisition called.");
...
/* 300:    */   }
/* 301:    */   
/* 302:    */   @RequestMapping(value={"/addpurreqitem.html"}, method={org.springframework.web.bind.annotation.RequestMethod.POST})
/* 303:    */   @ResponseBody
...
/* 330:    */   }
/* 331:    */   
/* 332:    */   @RequestMapping({"/delpurreqdt.html"})
/* 333:    */   @ResponseBody
